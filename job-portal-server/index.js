...
// app.use(cors()); //calling

// //user : swarupasinghps23
// //password : ASbDhqEq30vQ5Xkc

// const { MongoClient, ServerApiVersion } = require("mongodb");
// const uri = `mongodb+srv://${process.env.DB_USER}:${process.env.DB_PASSWORD}@job-portal-demo.gsjyz.mongodb.net/?retryWrites=true&w=majority&appName=job-portal-demo`;
